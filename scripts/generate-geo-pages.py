    ...
    <section class="section">
      <div class="container">
        ...
        <p class="text-center mt-l" data-reveal>
          <a href="https://wa.me/5554997021634" class="btn btn-primary" target="_blank" rel="noopener">Falar no WhatsApp</a>
        </p>
      </div>
    </section>
  </main>
